...
<div class="contentWrapper">
  <div class="content">
   ...
   <div>
        ...
        <div class="contentContentTeacherPerformanceContents">
          <p>スタティックの文言が入ります。スタティックの文言が入ります。スタティックの文言が入ります。スタティックの文言が入ります。スタティックの文言が入ります。スタティックの文言が入ります。スタティックの文言が入ります。</p> 
        <p>更新日：　2012/9/1</p>
        <div class="contentContentTeacherPerformanceHeader">
          実績
        </div>
        <p>実績の文言が入ります。実績の文言が入ります。実績の文言が入ります。実績の文言が入ります。実績の文言が入ります。実績の文言が入ります。実績の文言が入ります。実績の文言が入ります。実績の文言が入ります。</p>
        <div class="contentContentTeacherPerformanceHeader">
          取引内容・相場状況など
        </div>
        <p>取引内容・相場状況などの文言が入ります。取引内容・相場状況などの文言が入ります。取引内容・相場状況などの文言が入ります。取引内容・相場状況などの文言が入ります。取引内容・相場状況などの文言が入ります。</p>
