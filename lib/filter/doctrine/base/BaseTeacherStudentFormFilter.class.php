...
/**
 * TeacherStudent filter form base class.
 *
 * @package    DOUBLECLICK
 * @subpackage filter
 ...
 */
abstract class BaseTeacherStudentFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('teacher_student_filters[%s]');
